...
![Empty MeshShift workspace with the Choose files control](images/meshshift-01-open-file.png)

![Loaded potion.glb in the input viewer and conversion queue](images/meshshift-02-file-loaded.png)
...
These are absolute triangle targets per mesh. Leave a target at `0` to use MeshShift's automatic, quality-focused target. Keep the LOD levels you want to export checked in the **Files** area.

![Profiles dialog with two LOD levels and explicit triangle targets](images/meshshift-03-lod-settings.png)

## 3. Generate the optimized preview

Click **Generate optimized preview**. The progress panel reports the active optimization phase while MeshShift prepares the geometry and generates the LODs.

![Optimized preview generation in progress](images/meshshift-04-generating-preview.png)
...
![Completed optimized preview with the LOD report](images/meshshift-05-preview-ready.png)

## 4. Pin important vertices

Click **Edit detail pins**, select the LOD that should retain the point, and click the model where the vertex matters. MeshShift locks the nearest vertex from that LOD through deeper levels. The pinned point appears in the **Detail pins** list.

![A pinned vertex shown in the output viewer and Detail pins list](images/meshshift-06-pin-vertex.png)
...
![Output viewer in wireframe mode with three pinned vertices](images/meshshift-08-wireframe-multiple-pins.png)
...
![LOD0 wireframe preview with three pinned vertices](images/meshshift-09-lod0-multiple-pins.png)

![LOD1 wireframe preview with three pinned vertices](images/meshshift-10-lod1-multiple-pins.png)

![LOD2 wireframe preview with three pinned vertices](images/meshshift-11-lod2-multiple-pins.png)
