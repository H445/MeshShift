...
This document turns the release readiness findings into an ordered
...
| ----: | :------- | :------------------------------------------- | :----------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------------------------------ | :---------------------------------------------------------- |
|     1 | P1       | Hosted CI and provenance sign-off            | Approved commit pushed to the protected repository           | Run Node 22/24 quality jobs and Ubuntu/Windows/macOS platform smoke; retain package, SBOM, test, benchmark, reliability, packed-consumer, and manifest evidence; verify the OIDC attestation subject matches the package SHA-256                          | Release Engineering / Security  | Block until pass and attestation is verified                |
